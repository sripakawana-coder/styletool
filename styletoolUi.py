...
class StyleToolDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.imagePixmap = QtGui.QPixmap(f'{IMAGE_DIR}/Untitled.png')
        ...
        self.nameLineEdit.setStyleSheet(
            '''
            QLineEdit {
                background-color:qlineargradient(x1:0,y1:0.5,x2:0.5,y2:1,stop:0 blue,stop:1 navy);
                color:white;
                border-radius: 8px;
                font-family:Arial;
                font-weight:bold;
        ...
        self.saveButton = QtWidgets.QPushButton("Cancel")
